...
- eclipseche-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- eclipseche-ui: main application module, development time
- eclipseche-production: module that produces a production mode WAR for deployment
